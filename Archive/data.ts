...
function getAPR(name:string, transactions:any[]){
    let deposits = 0;
    let withdrawals = 0
    ...
    let APR = (withdrawals/deposits*100-100)/(
        (transactions[transactions.length-1]['when'].getTime()-transactions[1]['when'].getTime())/1000.0/365/24/60/60)
